...
const mockStories = [
  {
    ...
    type: "spot_discovery",
    imageSrc:
      "https://images.unsplash.com/photo-1572052800318-3f4007a8b4a7?w=500",
    author: "JejuExplorer",
    avatar: "https://placehold.co/30x30/E8A978/FFFFFF?text=J",
    timeAgo: "1시간 전",
    photo: "https://images.unsplash.com/photo-1572052800318-3f4007a8b4a7?w=500",
  ...
  },
  {
    ...
    type: "timer_story",
    imageSrc:
      "https://images.unsplash.com/photo-1517838277531-41214a1a3a35?w=500",
    author: "열정러너",
    avatar: "https://placehold.co/30x30/A5A5A5/FFFFFF?text=R",
    timeAgo: "3시간 전",
    photo: "https://images.unsplash.com/photo-1517838277531-41214a1a3a35?w=500",
    caption: "오늘의 기록",
  },
  {
    id: 3,
    type: "plain",
    imageSrc:
      "https://images.unsplash.com/photo-1533105079780-52b9be4ac26c?w=500",
    author: "바다사랑",
    avatar: "https://placehold.co/30x30/3498db/FFFFFF?text=S",
    timeAgo: "5시간 전",
    photo: "https://images.unsplash.com/photo-1533105079780-52b9be4ac26c?w=500",
    caption: "해변 러닝은 진리",
  },
  {
    id: 4,
    type: "plain",
    imageSrc: "https://images.unsplash.com/photo-1542037104-924825a12622?w=500",
    author: "산들바람",
    avatar: "https://placehold.co/30x30/2ecc71/FFFFFF?text=B",
    timeAgo: "어제",
    photo: "https://images.unsplash.com/photo-1542037104-924825a12622?w=500",
    caption: "오름 정상에서",
  },
  {
    id: 5,
